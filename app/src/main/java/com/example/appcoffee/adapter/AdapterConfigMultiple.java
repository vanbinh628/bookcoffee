...
public class AdapterConfigMultiple extends RecyclerView.Adapter<AdapterConfigMultiple.ViewHolder> {
    Context context;
    List<Config> configList;

    public AdapterConfigMultiple(Context context, List<Config> configList) {
